...
export const ISSUER_TAGS_TRANSLATIONS: TTagsTranslations[] = [
    ...
    {
        possibleNames: ['ИНН', 'ИННФЛ', 'ИНН ФЛ', 'INN', 'ИНН физического лица'],
        translation: 'ИНН',
    },
    {
        possibleNames: ['ИННЮЛ', 'ИНН ЮЛ', 'INN LE', 'INNLE', 'ИНН организации'],
        translation: 'ИНН организации',
    },
    { possibleNames: ['E', 'email', 'emailAddress', 'pkcs9email'], translation: 'Email' },
    { possibleNames: ['L', 'localityName'], translation: 'Город' },
];

export const SUBJECT_TAGS_TRANSLATIONS: TTagsTranslations[] = [
    { possibleNames: ['UN', 'UnstructuredName'], translation: 'Неструктурированное имя' },
...
export const OIDS_DICTIONARY: Record<string, string> = {
