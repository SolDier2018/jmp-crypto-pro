(function () {
    ...
    function set_log_level(level) {
        if (
            ...
            cpcsp_console_log(
                ...
                'cadesplugin_api.js: Incorrect log_level: ' + level
            );
    ...
    function set_constantValues() {
        ...
        cadesplugin.XmlDsigGost3410UrlObsolete =
        ...
        cadesplugin.XmlDsigGost3411Url2012256 =
            'urn:ietf:params:xml:ns:cpxmlsec:algorithms:gostr34112012-256';
        cadesplugin.XmlDsigGost3410Url2012256 =
            'urn:ietf:params:xml:ns:cpxmlsec:algorithms:gostr34102012-gostr34112012-256';
        cadesplugin.XmlDsigGost3411Url2012512 =
            'urn:ietf:params:xml:ns:cpxmlsec:algorithms:gostr34112012-512';
        cadesplugin.XmlDsigGost3410Url2012512 =
    ...
    var ru_cryptopro_npcades_10_native_bridge = {
        ...
        call: function call(functionName, args, callback) {
            ...
            var callbackId = hasCallback
                ? ru_cryptopro_npcades_10_native_bridge.callbacksCount++
                : 0;
            ...
            try {
                iframe.setAttribute(
                    ...
                    'cpnp-js-call:' +
                        ...
                        callbackId +
                        ':' +
                        encodeURIComponent(JSON.stringify(args, arrObjs))
                );
            } catch (e) {
                alert(e);
            }
    ...
    function show_firefox_missing_extension_dialog() {
        if (!window.cadesplugin_skip_extension_install) {
            ...
            document
                .getElementById('cadesplugin_close_install')
            ...
            function (event) {
                ...
                if (isFireFox || isSafari) {
                    ...
                    if (
                        ...
                        !url.match(
                            '^safari-extension://[a-zA-Z0-9-]+/[a-zA-Z0-9]+/nmcades_plugin_api.js$'
                        )
                    ) {
                        cpcsp_console_log(
                            cadesplugin.LOG_LEVEL_ERROR,
                            'Bad url "' +
                                url +
                                '" for load CryptoPro Extension for CAdES Browser plug-in'
                        );
                        plugin_loaded_error();
